...
/// over REST that must remove/placeholder the bubble live in A's chat. Covers 1TO1-036..040,
/// RT-DEL-001..005.
///
...
final class DeleteMessageTests: XCTestCase {
    ...
    /// Delete an own message: send, delete via popup + confirm, the original text is gone. (1TO1-036)
    func test_1TO1_036_deleteOwnMessage() throws {
        openSeeded()
    ...
    /// Deleting shows a confirmation affordance before removing. (1TO1-037)
    func test_1TO1_037_deleteShowsConfirmation() throws {
        openSeeded()
    ...
    /// The deleted-message placeholder replaces the bubble. (1TO1-038)
    func test_1TO1_038_deletedShowsPlaceholder() throws {
        openSeeded()
    ...
    /// A peer (B) message survives A's long-press — A cannot remove it from view. (1TO1-040)
    func test_1TO1_040_cannotDeletePeerMessage() throws {
        openSeeded()
    ...
    /// B deletes a message via REST; A sees it removed/placeholdered live. (1TO1-039 / RT-DEL-001)
    func test_1TO1_039_peerDeletesLive() throws {
        openSeeded()
    ...
    /// B deletes a message while A is on the Chats list; the preview drops/placeholders it. (RT-DEL-004)
    func test_RT_DEL_004_peerDeleteUpdatesPreview() throws {
