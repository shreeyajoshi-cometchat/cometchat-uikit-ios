...
/// Group admin / member operations (E2E-030→035) driven against a THROWAWAY per-run group, never the
...
final class E2EAdminCheckTests: XCTestCase {
    ...
    // MARK: - Change scope / role (E2E-034)
    ...
    // MARK: - Change scope to participant / demote (GRP-077)
