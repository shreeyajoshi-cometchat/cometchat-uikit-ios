...
/// clears once A opens the conversation. Covers RT-MSG-013/014. The badge is
...
///
/// The A↔B 1:1 lives on the shared backend, so its prior unread count isn't ours to control — RT-MSG-013
/// asserts a POSITIVE badge appeared (not an exact 3); RT-MSG-014 asserts it clears after reading.
