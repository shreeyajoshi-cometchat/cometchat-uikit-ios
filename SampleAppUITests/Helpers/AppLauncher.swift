...
enum AppLauncher {
    ...
    /// (`openConversationWith`, the canonical 1TO1-002 flow), which this now delegates to. Name kept for
    ...
    /// 1TO1-002 flow). Users search filters in place (unlike Chats search, which pushes a separate screen).
    @discardableResult
